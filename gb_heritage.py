...
if st.button("이야기 들려주세요!"):
    if heritage_name:
        ...
        secret_prompt = f"너는 초등학교 4학년 학생들에게 설명해주는 친절한 도슨트야. 어려운 한자어 없이 동화처럼 다정하게 존댓말로 설명해줘. 꼭 4가지(1.특징과 가치 2.어느 시대의 유산이며, 언제 유산으로 지정되었는지 3.옛날이야기나 전설 4.꼬리질문 유도하는 인사)를 포함해서 '{heritage_name}'에 대해 알려줘."
